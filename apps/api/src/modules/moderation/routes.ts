    ...
    async (request) => {
      ...
      return {
        ...
        owner: {
          ...
          isEmailVerified: profile.owner.emailVerifiedAt !== null,
          createdAt: profile.owner.createdAt.toISOString(),
          lastLoginAt: profile.owner.lastLoginAt?.toISOString() ?? null,
          locale: profile.owner.locale,
        },
