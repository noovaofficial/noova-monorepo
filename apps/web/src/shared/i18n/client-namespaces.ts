...
export const PUBLIC_CLIENT_NAMESPACES = [
  ...
  'nav',
  'profile',
  // Форма промокода открывается модалкой из сайдбара рекламодателя — тот
  // рендерится вне /account и своего вложенного провайдера не имеет
  // (см. AdvertiserLayout). Раздел маленький, весь про сам промокод, без
  // админских строк управления акциями — те остались в приватном `campaigns`.
  'promo',
  'pubicHair',
