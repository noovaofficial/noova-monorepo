...
/**
 * Выбор места на карте. Leaflet грузится динамическим импортом — так же, как
 * на публичной странице анкеты и на карте каталога: в общий бандл он не
 * попадает и достаётся только тем, кто карту открыл.
 *
