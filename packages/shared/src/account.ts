...
export const PROFILE_LIMIT_BY_ADVERTISER: Record<AdvertiserKind, number> = {
  ...
  salon: 1,
  // Плоский тариф агентства включает восемь анкет и доплат за девятую не
  // предусматривает (payments.md §3.3, D-07). Предел совпадает с тарифом:
  // разрешить больше значило бы отдать размещение бесплатно.
  agency: 8,
};
